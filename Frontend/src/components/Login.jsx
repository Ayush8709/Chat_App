...
function Login() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("ChatApp", JSON.stringify(response.data)); // response localstorage me save ho raha hai
      setAuthUser(response.data); //yaha se AuthProvider me response.data ko veja ja raha hai 
    } catch (error) {
      if (error.response) {
